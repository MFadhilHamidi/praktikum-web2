            ...
            <div class="card-body">
                <form method="POST" action="?page=matakuliah-update" class="form-horizontal">
                    <div class="form-group">
                        <label for="nim" class="col-sm-2 control-label">Kode Matakuliah</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="sks" class="col-sm-2 control-label">Sks Matakuliah</label>
                        <div class="col-sm-10">
                            <select class="form-control" name="sks">
                                <option disabled> Pilih </option>
                                <option <?php if ($sks == "22") echo 'selected'; ?> value="22">22</option>
                                <option <?php if ($sks == "24") echo 'selected'; ?> value="24">24</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="alamat" class="col-sm-2 control-label">Semester Matakuliah</label>
                        <div class="col-sm-10">
