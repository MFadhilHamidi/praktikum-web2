<div class="card">
    ...
    <div class="card-body">
        ...
        <!-- <div class="col-md-12"> -->
        <a href="?page=user_add" class="btn btn-primary mb-2">Tambah Data</a>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                $query = mysqli_query($con, "SELECT * FROM users LIMIT $mulai, $limit") or die(mysqli_error($conn));
                ?>
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM users WHERE username LIKE '%" . $keyword . "%'");
                        }
                    }
