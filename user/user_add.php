...
if (isset($_POST['registrasi'])) {
    ...
    $cekUsername = mysqli_query($con, "SELECT * FROM users WHERE username = '" . $username . "' ");
    ...
    $exec = mysqli_query($con, "INSERT INTO users(username,password) VALUES('$username','$passHash')");
    if ($exec === true) {
